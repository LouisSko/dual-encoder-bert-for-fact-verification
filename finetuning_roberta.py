...
from bert_encoder import DataLoaderNegativeBatches, train, DualEncoderRoberta
import sys


def finetuning_roberta(batch_size=32, save_dir=None):
...
if __name__ == '__main__':
    ...
    finetuning_roberta(batch_size=128, 
                    save_dir = '/home/kit/stud/ulhni/nlp_project/training_results/roberta_bs200')
