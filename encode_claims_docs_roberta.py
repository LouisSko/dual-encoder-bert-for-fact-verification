...
from bert_encoder import DualEncoderBert, TextDataGenerator, bert_encode_claims, bert_encode_docs, DualEncoderRoberta
...
def encode(path_model, batch_size=512, save_dir=None):
    ...
    # initialize model
    model = DualEncoderRoberta('roberta-base').to(device)
    ...
    df_db['text'] = df_db['article_name'] + '. ' + df_db['text']
...
if __name__ == '__main__':
    encode(path_model='/home/kit/stud/ulhni/nlp_project/training_results/roberta_bs128_V2/best_model.pt', 
           batch_size=1024, 
           save_dir = '/home/kit/stud/ulhni/nlp_project/embeddings/roberta_bs128_V2')
